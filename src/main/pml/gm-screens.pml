...
<document>
    ...
    <page>
        ...
        <markdown pos="50,800" width="495"
                  ...
                  table-border="1"
                  block-padding="1"
                  src="../markdown/tables/navrpg-races-attributes.md" />

        <markdown pos="50,700" width="155"
                  table-background="#eee,#fff"
                  table-border="1"
                  block-padding="1"
                  src="../markdown/tables/attributes-table.md" />
    </page>
    <page>
        <markdown pos="50,800" width="245"
                  table-background="#eee,#fff"
                  table-border="1"
                  block-padding="1"
                  src="../markdown/tables/skill-vs-stats.md" />
    </page>
    <page>
        <markdown pos="50,800" width="495"
                  table-background="#eee,#fff"
                  table-border="1"
                  block-padding="1"
                  src="../markdown/tables/navrpg-culture-mods.md" />
    </page>
    <page>
        <markdown pos="50,800" width="495"
                  table-background="#eee,#fff"
                  table-border="1"
                  block-padding="1"
                  src="../markdown/tables/navrpg-archetype-mods.md" />
    </page>
    <page>
